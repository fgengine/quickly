...
open class QPincodeComposition : QComposition< QPincodeComposable > {
    ...
    open override func apply(composable: QPincodeComposable, spec: IQContainerSpec) {
        ...
        composable.pincode.apply(self.pincode)
        if let error = self.error {
            error.apply(self.errorLabel)
        }
        composable.button0.apply(self.button0)
        composable.button1.apply(self.button1)
        composable.button2.apply(self.button2)
        composable.button3.apply(self.button3)
        composable.button4.apply(self.button4)
        composable.button5.apply(self.button5)
        composable.button6.apply(self.button6)
        composable.button7.apply(self.button7)
        composable.button8.apply(self.button8)
        composable.button9.apply(self.button9)
        if let buttonLeft = composable.buttonLeft {
            buttonLeft.apply(self.buttonLeft)
        }
        if self.pincode.isEmpty == true {
            if let buttonRight = composable.buttonRight {
                buttonRight.apply(self.buttonRight)
            }
        } else {
            composable.buttonBackspace.apply(self.buttonRight)
        }
    }
