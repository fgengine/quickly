...
open class QTitleDetailButtonComposition< Composable: QTitleDetailButtonComposable > : QComposition< Composable > {
    ...
    open override class func size(composable: Composable, spec: IQContainerSpec) -> CGSize {
        ...
        return CGSize(
            ...
            height: composable.edgeInsets.top + max(titleTextSize.height, detailTextSize.height, composable.buttonHeight) + composable.edgeInsets.bottom
        )
    }
    
    open override func preLayout(composable: Composable, spec: IQContainerSpec) {
        if self._edgeInsets != composable.edgeInsets || self._titleSpacing != composable.titleSpacing || self._buttonIsHidden != composable.buttonIsHidden || self._buttonSpacing != composable.buttonSpacing {
            ...
            var constraints: [NSLayoutConstraint] = [
                ...
                self.buttonView.leadingLayout == self.titleView.trailingLayout.offset(composable.buttonSpacing),
                self.buttonView.leadingLayout == self.detailView.trailingLayout.offset(composable.buttonSpacing),
