...
open class QImageTitleDetailIconComposition< Composable: QImageTitleDetailIconComposable > : QComposition< Composable > {
    ...
    open override class func size(composable: Composable, spec: IQContainerSpec) -> CGSize {
        ...
        let detailTextSize = composable.detail.size(width: availableWidth - (composable.imageWidth + composable.imageSpacing + composable.iconWidth + composable.iconSpacing))
