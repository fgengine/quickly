...
class TableController : QTableController {
    ...
    init(_ delegate: TableControllerDelegate) {
        ...
        self.sections = [
            QTableSection(rows: [
                QCompositionTableRow< QImageComposable >(composable: QImageComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm"))
                )),
                QCompositionTableRow< QImageTitleComposable >(composable: QImageTitleComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title"))
                )),
                QCompositionTableRow< QImageTitleShapeComposable >(composable: QImageTitleShapeComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title")),
                    shape: DisclosureShape(color: UIColor.black)
                )),
                QCompositionTableRow< QImageTitleIconComposable >(composable: QImageTitleIconComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title")),
                ...
                QCompositionTableRow< QImageTitleValueComposable >(composable: QImageTitleValueComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title")),
                    value: QLabelStyleSheet(text: QText("Value"))
                )),
                QCompositionTableRow< QImageTitleValueShapeComposable >(composable: QImageTitleValueShapeComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title")),
                    value: QLabelStyleSheet(text: QText("Value")),
                ...
                QCompositionTableRow< QImageTitleValueIconComposable >(composable: QImageTitleValueIconComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title")),
                    value: QLabelStyleSheet(text: QText("Value")),
                ...
                QCompositionTableRow< QImageTitleDetailComposable >(composable: QImageTitleDetailComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title")),
                    detail: QLabelStyleSheet(text: QText("Detail"))
                )),
                QCompositionTableRow< QImageTitleDetailShapeComposable >(composable: QImageTitleDetailShapeComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title")),
                    detail: QLabelStyleSheet(text: QText("Detail")),
                ...
                QCompositionTableRow< QImageTitleDetailIconComposable >(composable: QImageTitleDetailIconComposable(
                    image: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    imageWidth: 24,
                    title: QLabelStyleSheet(text: QText("Title")),
                    detail: QLabelStyleSheet(text: QText("Detail")),
                ...
                QCompositionTableRow< QTitleComposable >(composable: QTitleComposable(
                    title: QLabelStyleSheet(text: QText("Title"))
                )),
                QCompositionTableRow< QTitleValueComposable >(composable: QTitleValueComposable(
                    title: QLabelStyleSheet(text: QText("Title")),
                    value: QLabelStyleSheet(text: QText("Value"))
                )),
                QCompositionTableRow< QTitleValueShapeComposable >(composable: QTitleValueShapeComposable(
                    title: QLabelStyleSheet(text: QText("Title")),
                    value: QLabelStyleSheet(text: QText("Value")),
                    shape: DisclosureShape(color: UIColor.black)
                )),
                QCompositionTableRow< QTitleValueIconComposable >(composable: QTitleValueIconComposable(
                    title: QLabelStyleSheet(text: QText("Title")),
                    value: QLabelStyleSheet(text: QText("Value")),
                    icon: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    iconWidth: 24
                )),
                QCompositionTableRow< QTitleDetailComposable >(composable: QTitleDetailComposable(
                    title: QLabelStyleSheet(text: QText("Title")),
                    detail: QLabelStyleSheet(text: QText("Detail"))
                )),
                QCompositionTableRow< QTitleDetailShapeComposable >(composable: QTitleDetailShapeComposable(
                    title: QLabelStyleSheet(text: QText("Title")),
                    detail: QLabelStyleSheet(text: QText("Detail")),
                    shape: DisclosureShape(color: UIColor.black)
                )),
                QCompositionTableRow< QTitleDetailIconComposable >(composable: QTitleDetailIconComposable(
                    title: QLabelStyleSheet(text: QText("Title")),
                    detail: QLabelStyleSheet(text: QText("Detail")),
                    icon: QImageViewStyleSheet(source: QImageSource("icon_confirm")),
                    iconWidth: 24
                )),
                QCompositionTableRow< QTitleButtonComposable >(composable: QTitleButtonComposable(
                    title: QLabelStyleSheet(text: QText("Title")),
                ...
                QCompositionTableRow< QTextFieldComposable >(composable: QTextFieldComposable(
                ...
                QCompositionTableRow< QListFieldComposable >(composable: QListFieldComposable(
                ...
                QCompositionTableRow< QDateFieldComposable >(composable: QDateFieldComposable(
